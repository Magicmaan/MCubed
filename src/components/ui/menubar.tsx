...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Root
		ref={ref}
		className={cn(
			'flex h-10 items-center space-x-1 rounded-md border border-neutral-200 bg-white p-1 font-Inter dark:border-neutral-800 dark:bg-neutral-950',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Trigger
		ref={ref}
		className={cn(
			'mx-0 flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none focus:bg-button-selected focus:text-neutral-900 data-[state=open]:bg-button-selected data-[state=open]:text-neutral-900 dark:focus:bg-button-selected dark:focus:text-neutral-50 dark:data-[state=open]:bg-button-hover dark:data-[state=open]:text-neutral-50',
			className
		)}
		{...props}
	/>
